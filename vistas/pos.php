              ...
              <div class="p-3 pb-0">
                ...
                <div id="container_datos" class="row">
                  ...
                  <div class="col-sm-6 mb-2">
                    ...
                    <label for="numero_boleta" class="">Número:</label>
                  ...
                  <div class="col-sm-6 mb-2">
                    <label for="tipo_doc_ide" class="">Tipo de DOC:</label>
                    <select class="form-select" name="tipo_doc_ide" id="tipo_doc_ide" onchange="focusI()"></select>
                  </div>

                  <div class="col-sm-6 mb-2">
                    <label for="numero_documento" class="">Nro (Presione Enter):</label>
                  ...
                  <div class="col-sm-6 mb-2">
                    <label for="razon_social" class="" id="txt_razon_social">Nombres y apellidos:</label>
                  ...
                  <div class="col-sm-6 mb-2">
                    <label for="domicilio_fiscal" class="" id="txt_domicilio_fiscal">Dirección:</label>
