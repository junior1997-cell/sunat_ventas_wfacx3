    ...
    <div class="">
      <div class="">
        <div class="content-header">
          ...
          <h1>Productos <button class="btn btn-primary btn-sm" onclick="mostrarform(true)" data-bs-toggle="modal" data-bs-target="#modalAgregarProducto">Agregar</button> <button class="btn btn-success btn-sm" id="importarDatos" data-bs-toggle="modal" data-bs-target="#importararticulos">Importar Artículos</button></h1>
            ...
            <form name="formulario" id="formulario" method="POST">
              <div class="row">
                ...
                <div class="mb-3 col-lg-2">
                  ...
                  <input type="text" class="form-control" name="codigo" id="codigo" placeholder="Código Barras" required="true" onkeyup="mayus(this);" onblur="generarbarcode()" onchange="validarcodigo()">
