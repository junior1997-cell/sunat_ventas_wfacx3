                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="cbaja.php" class="side-menu__item">Anular Boletas</a>
                                </li>
                                <li class="slide">
                                    <a href="resumend.php" class="side-menu__item">Anular Facturas</a>
                                </li>
                                <li class="slide">
                        ...
                        if ($_SESSION['kardex'] == 1) {
                            echo '<li class="slide__category"><span class="category-name">Reportes Generales</span></li>
                            <li class="slide">
                        ...
                        if ($_SESSION['inventarios'] == 1) {
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="registroinventario.php" class="side-menu__item">Registro inventario</a>
                                </li>
                        ...
                        if ($_SESSION['acceso'] == 1) {
                            echo '<li class="slide__category"><span class="category-name">Ajustes del sistema</span></li> 
