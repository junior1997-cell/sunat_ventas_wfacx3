        ...
        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
          <div class="d-flex align-items-center">
            <div class="me-sm-2 me-0">
              <img src="../files/usuarios/<?php echo $_SESSION['imagen']; ?>" alt="img" width="32" height="32" class="rounded-circle">
            </div>
            <div class="d-sm-block d-none">
              <p class="fw-semibold mb-0 lh-1"><?php echo $_SESSION['nombre']; ?></p>
              <span class="op-7 fw-normal d-block fs-11"><?php echo $_SESSION['cargo']; ?></span>
            </div>
          </div>
        </a>
        <!-- End::header-link|dropdown-toggle -->
        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
          <li><a class="dropdown-item d-flex" href="../vistas/usuario.php"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Perfil</a></li>
          <li><a class="dropdown-item d-flex" href="../vistas/empresa.php"><i class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Ajustes</a></li>
          <li><a class="dropdown-item d-flex" href="https://wa.link/t3lxqj"><i class="ti ti-headset fs-18 me-2 op-7"></i>Soporte</a></li>
          <li><a class="dropdown-item d-flex" target="_blank" href="../ajax/usuario.php?op=salir"><i class="ti ti-logout fs-18 me-2 op-7"></i>Salir</a></li>
        </ul>
      </div>
      <!-- End::header-element -->
