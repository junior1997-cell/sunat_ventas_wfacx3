      ...
      <div class="content-start transition">
        ...
        <section class="container-fluid dashboard">
          <div class="content-header">
            <h1>Resumen diario de bajas de boletas</h1>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            <div class="mt-3 col-lg-2">
                              <button class="btn btn-danger" name="generarbajaxml" onclick="generarbajaxml()"
                                style="top: 72px;">Generar Xml y Anular</button>
                            </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <div class="table-responsive" id="listadoregistros">
                              <table id="tbllistadoxml" class="table table-striped"
                                style="font-size: 14px; max-width: 100%; !important;">
                                <thead style="text-align:center;">
                                  <th>FECHA ENVIO</th>
                            ...
                            <div class="table-responsive" id="listadoregistros">
                              <table id="tbllistadocomprobante" class="table table-striped"
                                style="font-size: 14px; max-width: 100%; !important;">
                                <thead style="text-align:center;">
