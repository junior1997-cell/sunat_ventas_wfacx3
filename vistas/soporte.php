          ...
          <div class="col-md-12">
            <div class="box">
              ...
              <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <label><a href="mailto:gerencia@gerencia.jdl.pe">gerencia@gerencia.jdl.pe</a></label><br>
                <label>Teléfonos:</label></br>
                <label>Móvil: <a href="tel:+51921487276">921487276</a></label><br>
                <label>Web:</label>
                <a href="jdl.pe" target="_blank">JDL TECHNOLOGY</a>
