...
?>
    ...
    <div class="content-start transition  ">
      <div class="container-fluid dashboard">
        <div class="content-header">
          <h1>Servicio <button class="btn btn-primary btn-sm" onclick="mostrarform(true)" data-bs-toggle="modal" data-bs-target="#modalAgregarProducto">Agregar</button> <button class="btn btn-success btn-sm" id="refrescartabla" onclick="refrescartabla()">Refrescar tabla</button></h1>
        </div>
    ...
    <div class="modal fade text-left" id="modalAgregarProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
            ...
            <form name="formulario" id="formulario" method="POST">
              <div class="row">
                ...
                <div class="mb-3 col-lg-3">
                  ...
                  <select class="form-control select2" name="idfamilia" id="idfamilia" required style="width: 100%;" data-live-search="true">
                  </select>
                </div>
                ...
                <div class="mb-3 col-lg-3">
                  ...
                  <select class="form-control" name="tipoitem" id="tipoitem" onchange="focuscodprov()">
                    <option value="servicios" <%=selectedValue==="servicios" ? "selected" : "" %>SERVICIO </option>
                ...
                <div class="mb-3 col-lg-3">
                  ...
                  <select class="form-control" name="unidad_medida" id="unidad_medida" required data-live-search="true" onchange="costoco()">
                  </select>
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Descripción del servicio:</label>
                  <input type="text" class="form-control" name="nombre" id="nombre" maxlength="500" placeholder="Nombre" required="true" onkeyup="mayus(this);" onkeypress=" return limitestockf(event, this)" data-tooltip="Información de este campo" data-tooltip-more="Descripción del artículo,  aparecera en el detalle del comprobante." data-tooltip-stickto="top" data-tooltip-maxwidth="500" data-tooltip-animate-function="foldin" data-tooltip-color="green">
                ...
                <div class="mb-3 col-lg-2" hidden>
                  ...
                  <input type="text" class="form-control stokservicio" name="stock" id="stock" maxlength="500" placeholder="Stock" required="true">
                </div>
                <div class="mb-3 col-lg-2" hidden>
                  <label for="recipient-name" class="col-form-label">Limite stock:</label>
                  <input type="text" class="form-control" name="limitestock" id="limitestock" maxlength="500" placeholder="Limite de stock" data-tooltip="Información de este campo" data-tooltip-more="Aquí ingrese el milite de stock para que se bloquee las ventas al llegar a su limite." data-tooltip-stickto="top" data-tooltip-maxwidth="500" data-tooltip-animate-function="foldin" data-tooltip-color="green" onkeypress=" return limitest(event, this)">
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Código de servicio:</label>
                  <input type="text" class="form-control" name="codigo" id="codigo" placeholder="Código interno de servicio" required="true" onkeyup="mayus(this);" onblur="generarbarcode()" onchange="validarcodigo()">
                ...
                <div class="row" id="mostrarCompra" style="display: none;">
                  <div class="row">
                    ...
                    <div class="mb-3 col-lg-4">
                      ...
                      <input type="text" class="form-control" name="codigo_proveedor" id="codigo_proveedor" placeholder="Código de proveedor" required="" onkeyup="mayus(this)" onkeypress="return focusnomb(event, this)" data-tooltip="Información de este campo" data-tooltip-more="Aquí ingrese si su artículo tiene un código que viene desde el proveedor, es opcional, si no tiene un codigo puede poner un . o -" data-tooltip-stickto="top" data-tooltip-maxwidth="500" data-tooltip-animate-function="foldin" data-tooltip-color="green">
                    </div>
                ...
                <div class="mb-3 col-lg-4" hidden>
                  ...
                  <input type="text" class="form-control salini" name="saldo_iniu" id="saldo_iniu" maxlength="500" placeholder="Saldo inicial" onBlur="calcula_valor_ini()" required="true" onkeypress="return valori(event, this)" data-tooltip="Información de este campo" data-tooltip-more="Si es la primera vez que llena este campo poner el saldo final de su inventario físico. " data-tooltip-stickto="top" data-tooltip-maxwidth="500" data-tooltip-animate-function="foldin" data-tooltip-color="green">
                ...
                <div class="mb-3 col-lg-4" hidden>
                  ...
                  <input type="text" class="form-control convumventa" name="fconversion" id="fconversion" readonly>
