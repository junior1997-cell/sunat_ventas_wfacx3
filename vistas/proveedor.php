...
?>
    ...
    <div class="content-header">
      <h1>Proveedores <button class="btn btn-success btn-sm" onclick="mostrarform(true)" data-bs-toggle="modal" data-bs-target="#agregarProveedores">Agregar</button></h1>
    </div>
    ...
    <div class="modal fade text-left" id="agregarProveedores" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
            ...
            <form name="formulario" id="formulario" method="POST">
              <div class="row">
                <div class="mb-3 col-lg-4">
                  ...
                  <input type="text" class="form-control" name="nombres" id="nombres" maxlength="100" required onkeyup="mayus(this);">
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Apellidos:</label>
                  <input type="text" class="form-control" name="apellidos" id="apellidos" maxlength="100" required onkeyup="mayus(this);">
                </div>
                ...
                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label" id="l_tipo_documento">N°
                    Documento:</label>
                  <input type="text" class="form-control" name="numero_documento" id="numero_documento" maxlength="11" onblur="validarProveedor();" onkeypress="return NumCheck(event, this)">
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Razón Social:</label>
                  <input type="text" class="form-control" name="razon_social" id="razon_social" maxlength="100" required onkeyup="mayus(this);">
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Nombre comercial:</label>
                  <input type="text" class="form-control" name="nombre_comercial" id="nombre_comercial" maxlength="100" required onkeyup="mayus(this);">
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Domicilio fiscal:</label>
                  <input type="text" class="form-control" name="domicilio_fiscal" id="domicilio_fiscal" maxlength="100" required onkeyup="mayus(this);">
                </div>
                ...
                <div class="mb-3 col-lg-4">
                  ...
                  <input type="text" class="form-control" name="telefono1" id="telefono1" maxlength="15" onkeypress="return NumCheck(event, this)">
                  </select>
                </div>

                <div class="mb-3 col-lg-4">
                  <label for="recipient-name" class="col-form-label">Celular:</label>
                  <input type="text" class="form-control" name="telefono2" id="telefono2" maxlength="15" onkeypress="return NumCheck(event, this)">
                </div>
