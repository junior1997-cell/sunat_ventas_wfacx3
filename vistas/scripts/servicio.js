...
function init() {
  ...
  $("#formulario").on("submit", function (e) { guardaryeditarservicio(e); });

  $("#formularioncliente").on("submit", function (e) { guardaryeditarcliente(e); });

  // Carga de departamentos para clientes =====================
  $.post("../ajax/persona.php?op=selectDepartamento", function (r) {  $("#iddepartamento").html(r); $('#iddepartamento').selectpicker('refresh'); });
  // Carga de departamentos para clientes =====================
