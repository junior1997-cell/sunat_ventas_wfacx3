        ...
        data.ListaProductos.forEach(product => { 
          ...
          productCardAlert.innerHTML = `
            <div class="text-center" style="height: 120px;">
              <img src="${productImage}" alt="${product.nombre}" height="100%" class=" mb-2"  onerror="this.src='../files/articulos/no_img_avaliable.jpg';">
            </div>
...
function focusI() {
  ...
  if (tipo == "0") {
    $.post( "../ajax/persona.php?op=mostrarClienteVarios",
    ...
    $("#txt_razon_social").text("Nombres y apellidos:");
    $("#txt_domicilio_fiscal").text("Dirección:");
  }
  ...
  if (tipo == "6") {
    ...
    $("#txt_razon_social").text("Razón Social:");
    $("#txt_domicilio_fiscal").text("Domicilio Fiscal:");
...
//prueba
// var settings = {
//   "url": "https://wfacx.com/sistema/ajax/pos.php?action=listarComprobantesVarios",
//   "method": "POST",
//   "timeout": 0,
//   "headers": {
