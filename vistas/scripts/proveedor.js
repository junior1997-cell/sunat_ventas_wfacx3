        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (!jQuery.isEmptyObject(data.error)) {
              ...
              $('#razon_social').val(`${data.nombres} ${data.apellidoPaterno} ${data.apellidoMaterno}`);
              $('#nombre_comercial').val(`${data.nombres} ${data.apellidoPaterno} ${data.apellidoMaterno}`);
            }
          },
          error: function (data) {
            // alert("Problemas al tratar de enviar el formulario");
