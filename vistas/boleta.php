    ...
    <div class="">
      ...
      <section class="">
        <div class="content-header">
          <h1>Boleta electrónica <button class="btn bg-primary btn-sm text-white" id="btnagregar" onclick="mostrarform(true); limpiar()">Nuevo</button> 
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-lg-12">
                            <label for="recipient-name" class="col-form-label">Nombres y
                              apellidos: <span class="buscando_cliente"> </span> </label>
