         ...
         <td><input type="text" id="max" name="max" class="form-control" placeholder="ej. 1,050.50"></td>
              ...
              <div class="panel-body" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12">
                    <label>Número</label> <input type="text" style="font-size: 12pt;" name="numero_servicio" id="numero_servicio" class="form-control" required="true" readonly style="font-size: 22px">
                  </div>
    ...
    <input type="hidden" name="ruc_empresa" id="ruc_empresa" value="20100088917"> -->
                  ...
                  <div class="row">
                    <div class="form-group  col-lg-3 col-md-6 col-sm-6 col-xs-12">
                      ...
                      <input type="date" style="font-size: 12pt;" class="form-control" name="fecha_emision" id="fecha_emision" required="true" disabled="true">
                    </div>
                  ...
                  <div class="row">
                    <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12">
                      <input type="text" class="form-control" name="numero_documento2" id="numero_documento2" maxlength="11" placeholder="RUC DE CLIENTE-ENTER" required="true" onkeypress="agregarClientexRuc(event)">
                    </div>
                    <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                      <input type="text" class="form-control" name="razon_social2" id="razon_social2" required="true" placeholder="RAZÓN SOCIAL">
                      <!-- <select id="razon_social2" name="razon_social2" class="form-control selectpicker" data-live-search="true" required >  </select> -->
                    </div>

                    <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                      <input type="text" class="form-control" name="domicilio_fiscal2" id="domicilio_fiscal2" required="true" placeholder="DIRECCIÓN CLIENTE">
                    </div>

                    <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                      <input type="text" class="form-control" name="correocli" id="correocli" required="true" placeholder="CORREO CLIENTE" onkeypress="return focusbotonarticulo(event, this)" onfocus="focusTest(this)">
                    </div>
                  ...
                  <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-6">
                    </a><button class="btn btn-primary" type="submit" id="btnGuardar" data-toggle="tooltip" title="Guardar factura"><i class="fa fa-save"></i> Guardar</button>
      ...
      <div class="modal-dialog" style="width: 100% !important;">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a data-toggle="modal" href="#ModalNcliente">
              <button type="button" class="btn btn-primary" data-dismiss="modal" onclick=""><i class="fa fa-user" data-toggle="tooltip" title="Nuevo cLiente"></i> Nuevo cliente</button>
            </a>
          ...
          <div class="modal-body">
            ...
            <form name="formularioncliente" id="formularioncliente" method="POST">
              ...
              <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="text" class="form-control" name="razon_social" id="razon_social" maxlength="100" placeholder="Razón social" required onkeypress="return focusDomi(event, this)">
              </div>


              <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <label>Domicilio:</label>
                <input type="text" class="form-control" name="domicilio_fiscal" id="domicilio_fiscal" maxlength="100" placeholder="Domicilio fiscal" required onkeypress="focustel(event, this)">
              </div>

              <!--  <div class="form-group col-lg-2 col-md-12 col-sm-12 col-xs-12">
              <label>Dep.:</label>
              <select  class="form-control select-picker" name="iddepartamento" id="iddepartamento"  data-live-search="true" onchange="llenarCiudad()" >
              </select>
              </div>

              <div class="form-group col-lg-2 col-md-12 col-sm-12 col-xs-12">
              <label>Ciud.:</label>
              <select  class="form-control select-picker" name="idciudad" id="idciudad" onchange="llenarDistrito()" data-live-search="true" >                       
              </select>
              </div>
              ...
              <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="email" id="email" maxlength="50" placeholder="CORREO" required="true" onkeypress="return focusguardar(event, this)">
              </div>

              <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12">
                <button class="btn btn-primary" type="submit" id="btnguardarncliente" name="btnguardarncliente" value="btnGuardarcliente"><i class="fa fa-save"></i> Guardar</button>

              </div>
              <div class="form-group col-lg-12 col-md-4 col-sm-6 col-xs-12">
                <iframe border="0" frameborder="0" height="450" width="100%" marginwidth="1" src="https://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/jcrS00Alias">
                </iframe>
              </div>
