...
if (!isset($_SESSION["nombre"])) {
        ...
        <div class="content-start transition">
              <div class="container-fluid dashboard">
                <div class="content-header">
                  <h1>Configuración catalogo #6 sunat tipo de documentos<button class="btn btn-primary btn-sm" onclick="mostrarform(true)" data-bs-toggle="modal" data-bs-target="#agregarcatalogo6sunat"> Agregar</button></h1>
                </div>
            ...
            <div class="modal fade text-left" id="agregarcatalogo6sunat" tabindex="-1" role="dialog" aria-labelledby="agregarcatalogo6sunat" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="agregarcatalogo6sunat">Añade nuevos documentos</h5>
                  ...
                  <div class="modal-body">
                    <form name="formulario" id="formulario" method="POST">
                      <div class="row">
                        ...
                        <div class="mb-3 col-lg-6">
                          <label for="message-text" class="col-form-label">Nombre documento:</label>
  ...
  require 'footer.php';
  ?>
    <script type="text/javascript" src="scripts/catalogo6.js"></script>
    <?php
}
ob_end_flush();
?>