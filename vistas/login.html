...
<body>
	<div class="wrapper">
		...
		<div class="form-box login">
			...
			<form method="post" id="frmAcceso" name="frmAcceso" onload="document.frmAcceso.logina.focus()"
				...
				<div class="input-box animation" style="--i:2; --j:23;">
					<input value="admin" id="clavea" name="clavea" type="password" required />
		...
		<div class="info-text login">
			<h2 class="animation" style="--i:0; --j:19;">Factura</h2>
			<p class="animation" style="--i:1; --j:20;">Electrónica <br>Gestión Empresarial</p>
		</div>
		...
		<div class="info-text register">
			<h2 class="animation" style="--i:17; --j:0;">Factura</h2>
			<p class="animation" style="--i:18; --j:1;">Electrónica <br>Gestión Empresarial</p>
		</div>
	</div>
