...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['escritorio'] == 1) {
    ...
    $regv = $rsptav->fetch_object();
    $productosmasvendidos = isset($regv->total) ? (empty($regv->total) ? 0 : floatval($regv->total)) : 0;
...
?>
          ...
          <div class="modal-body">
            <form name="formulariotcambio" id="formulariotcambio" method="POST">
              <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12" hidden>
                Fecha: <input type="date" name="fechatc" id="fechatc" value="<?php echo $fechatc; ?>" class="" <?php echo $dfecha; ?> onchange="consultartcambio();" readonly="true">
      ...
      <div class="col-xxl-9 col-xl-12">
        <div class="row">
                ...
                <div class="card custom-card crm-highlight-card">
                  <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                      <div>
                        <div class="fw-semibold fs-18 text-fixed-white mb-2">¡Bienvenido!</div>
                        ...
                        <span class="d-block fw-semibold mt-1"><a class="text-fixed-white" href="https://wa.link/t3lxqj" target="_blank"><u>SOPORTE</u></a></span>
                      </div>
                      <div>
                        <div id="crm-main"></div>
                      </div>
            ...
            <div class="col-xl-12">
              <div class="card custom-card">
                ...
                while ($regCliente = $rsptaClientesTop->fetch_object()) {
                  ...
                  echo '            <span class="text-muted fs-12">' . $regCliente->detallecliente . '</span>';
                  echo '        </div>';
                    ...
                    <div class="d-flex align-items-top justify-content-between">
                      <div>
                        <span class="avatar avatar-md avatar-rounded bg-primary">
                          <i class="ti ti-currency fs-16"></i>
                        </span>
                      </div>
                      <div class="flex-fill ms-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                          <div>
                            <a class="text-primary" href="javascript:void(0);">Ver más<i class="ti ti-arrow-narrow-right ms-2 fw-semibold d-inline-block"></i></a>
                          </div>
                          <div class="text-end">
                            <p class="mb-0 text-success fw-semibold">+</p>
                            <span class="text-muted op-7 fs-11">monto diario</span>
                          </div>
                        </div>
          ...
          <style>
            tbody {
              display: block;
              /* Esto hace que el tbody se comporte como un div */
              max-height: 225px;
              /* ajusta esto según tu necesidad */
              overflow-y: scroll;
            }
                ...
                <div class="d-flex flex-wrap gap-2">
                  ...
                  <div class="dropdown">
                    <a href="javascript:void(0);" class="btn btn-primary btn-sm btn-wave waves-effect waves-light" data-bs-toggle="dropdown" aria-expanded="false">
                      Filtro<i class="ri-arrow-down-s-line align-middle ms-1 d-inline-block"></i>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                      <li><a class="dropdown-item" href="javascript:void(0);">Nuevos</a></li>
                      <li><a class="dropdown-item" href="javascript:void(0);">Populares</a></li>
                      <li><a class="dropdown-item" href="javascript:void(0);">Relevantes</a></li>
                    </ul>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    function nextM(idnotificacion) {
      ...
      $.post("../ajax/ventas.php?op=avanzar", {
