...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['acceso'] == 1) {
    ...
    ?>
              ...
              <div class="content-start transition">        
                ...
                <section class="container-fluid dashboard">
                      <div class="content-header">
                          <h1>Resumen de baja notas de crédito</h1>
                      </div>
                    <div class="row">
                      <div class="col-md-12">
        ...
        <button class="btn btn-danger" name="generarbajaxml" name="generarbajaxml" onclick="generarbajaxml()"> Generar xml y Baja </button>
        </div>
