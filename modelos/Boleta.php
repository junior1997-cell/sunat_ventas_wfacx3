...
class Boleta
{
  ...
  public function insertar(  $idusuario, $fecha_emision_01, $firma_digital_36, $idempresa, $tipo_documento_06, $numeracion_07, $idcl, $codigo_tipo_15_1, $monto_15_2, 
  $sumatoria_igv_18_1, $sumatoria_igv_18_2, $sumatoria_igv_18_3, $sumatoria_igv_18_4, $sumatoria_igv_18_5, $importe_total_23, $codigo_leyenda_26_1, 
  $descripcion_leyenda_26_2, $tipo_documento_25_1, $guia_remision_25, $version_ubl_37, $version_estructura_38, $tipo_moneda_24, $tasa_igv, $idarticulo, 
  $numero_orden_item_29, $cantidad_item_12, $codigo_precio_14_1, $precio_unitario, $igvBD, $igvBD2, $afectacion_igv_3, $afectacion_igv_4, $afectacion_igv_5, 
  $afectacion_igv_6, $igvBD3, $vvu, $subtotalBD, $codigo, $unidad_medida, $idserie, $SerieReal, $numero_boleta, $tipodocuCliente, $rucCliente,
  $RazonSocial, $hora, $dctoitem, $vendedorsitio, $tcambio, $totaldescu, $domicilio_fiscal, $tipopago, $nroreferencia, $ipagado, $saldo, $descdet, $total_icbper,
  $tipoboleta, $cantidadreal, $ccuotas, $fechavecredito, $montocuota, $tadc, $transferencia, $ncuotahiden, $montocuotacre, $fechapago, $fechavenc, $efectivo, $visa, $yape,
  $plin, $mastercard, $deposito ) {
    ...
    $montotar = 0;   $montotran = 0;
    if ($tadc == '1') {  $montotar = $importe_total_23;  }

    if ($transferencia == '1') {  $montotran = $importe_total_23;  }

    $sql = "INSERT INTO  boleta (idusuario, fecha_emision_01, firma_digital_36, idempresa, tipo_documento_06, numeracion_07, idcliente, codigo_tipo_15_1, monto_15_2, 
    ...
    descripcion_leyenda_26_2, tipo_documento_25_1, guia_remision_25, version_ubl_37, version_estructura_38, tipo_moneda_24, tasa_igv, estado, tipodocuCliente, 
    rucCliente, RazonSocial, tdescuento, vendedorsitio, tcambio, tipopago, nroreferencia, ipagado, saldo, DetalleSunat, icbper, tipoboleta, formapago, montofpago,
    monedafpago, ccuotas, fechavecredito, montocuota, tarjetadc, transferencia, montotarjetadc, montotransferencia, fechavenc, efectivo, visa, yape, plin,
    mastercard, deposito )
    values ('$idusuario', '$fecha_emision_01 $hora', '$firma_digital_36', '$idempresa', '$tipo_documento_06', '$SerieReal-$numero_boleta', '$idcl', '$codigo_tipo_15_1', 
    '$monto_15_2', '$sumatoria_igv_18_1', '$sumatoria_igv_18_2', (select codigo from catalogo5 where codigo='$sumatoria_igv_18_3'), 
    (select descripcion from catalogo5 where codigo='$sumatoria_igv_18_3'), (select unece5153 from catalogo5 where codigo='$sumatoria_igv_18_3'),
    '$importe_total_23', '$codigo_leyenda_26_1', '$descripcion_leyenda_26_2', '$tipo_documento_25_1', '$guia_remision_25', '$version_ubl_37', '$version_estructura_38',
    '$tipo_moneda_24', '$tasa_igv', '$st', '$tipodocuCliente', '$rucCliente', '$RazonSocial', '$totaldescu', '$vendedorsitio', '$tcambio', '$formapago', '$nroreferencia',
    '$ipagado', '$saldo', 'EMITIDO', '$total_icbper', '$tipoboleta', '$formapago', '$montofpago', '$monedafpago', '$ccuotas', '$fechavecredito',
    '$montocuota', '$tadc', '$transferencia', '$montotar', '$montotran', '$fechavenc', '$efectivo', '$visa', '$yape', '$plin', '$mastercard', '$deposito')";
    ...
    try {
      ...
      if ($idBoletaNew == "") {
        ...
        while ($num_elementos < count($idarticulo)) {
          //Guardar en Detalle
          $sql_detalle = "INSERT INTO detalle_boleta_producto(idboleta, idarticulo, numero_orden_item_29, cantidad_item_12, codigo_precio_14_1, precio_uni_item_14_2, 
          afectacion_igv_item_monto_27_1, afectacion_igv_item_monto_27_2, afectacion_igv_3, afectacion_igv_4, afectacion_igv_5, afectacion_igv_6, igv_item, 
          valor_uni_item_31, valor_venta_item_32, dcto_item, descdet, umedida )
          values ( '$idBoletaNew', '$idarticulo[$num_elementos]', '$numero_orden_item_29[$num_elementos]', '$cantidad_item_12[$num_elementos]', '$codigo_precio_14_1', 
          '$precio_unitario[$num_elementos]', '$igvBD[$num_elementos]', '$igvBD2[$num_elementos]',
          (select codigo from catalogo7 where codigo='$afectacion_igv_3[$num_elementos]'), (select codigo from catalogo5 where codigo='$afectacion_igv_4[$num_elementos]'),
          (select descripcion from catalogo5 where codigo='$afectacion_igv_4[$num_elementos]'), (select unece5153 from catalogo5 where codigo='$afectacion_igv_4[$num_elementos]'),
          '$igvBD3[$num_elementos]', '$vvu[$num_elementos]', '$subtotalBD[$num_elementos]', '$dctoitem[$num_elementos]', '$descdet[$num_elementos]', '$unidad_medida[$num_elementos]' )";
          ...
          costo_2, valor_final, idempresa, tcambio, moneda) values
          ('$idBoletaNew', '$idarticulo[$num_elementos]', 'VENTA', '$codigo[$num_elementos]', '$fecha_emision_01', '03', '$SerieReal-$numero_boleta', 
          '$cantidadreal[$num_elementos]', '$vvu[$num_elementos]', '$unidad_medida[$num_elementos]', '', '', '', '$idempresa', '$tcambio', '$tipo_moneda_24')";
          ...
          if ($tipoboleta != 'servicios') {
            ...
            valor_finu=(saldo_iniu+comprast-ventast) * precio_final_kardex, stock=saldo_finu, valor_fin_kardex=(select valor_final 
            from kardex where idarticulo='$idarticulo[$num_elementos]' and transaccion='VENTA' order by idkardex desc limit 1)  
      ...
      values ('$idusuario', '$tipo_documento_06','$idBoletaNew', now())";
      ...
      if ($tipopago == 'Credito') {
        ...
        while ($numcuotas < count($ncuotahiden)) {
          ...
          values ( '03', '$idBoletaNew', '$ncuotahiden[$numcuotas]', '$montocuotacre[$numcuotas]', '$fechapago[$numcuotas]', '1' )";          
...
comentario_baja  
  ...
  public function reconsultarcdr($idboleta, $idempresa)
  {
    ...
    $sqlsendmail = "SELECT b.idboleta, p.email,  p.nombres, p.apellidos, p.nombre_comercial, e.numero_ruc, b.tipo_documento_06, b.numeracion_07, substring(b.numeracion_07,1,4) as serie,
