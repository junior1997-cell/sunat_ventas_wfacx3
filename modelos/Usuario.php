...
class Usuario
{
	...
	public function verificar($login, $clave, $empresa) {
		...
		$sql = "SELECT u.idusuario, u.nombre, u.tipo_documento, u.num_documento, u.telefono, u.email, u.cargo, u.imagen, u.login, e.nombre_razon_social, e.idempresa, co.igv,
		e.nombre_comercial, e.numero_ruc,	e.domicilio_fiscal  
		from usuario u 
