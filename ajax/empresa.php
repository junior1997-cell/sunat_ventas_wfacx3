  ...
  case 'guardaryeditar':
    ...
    if (empty($idempresa)) {
      ...
      $rspta = $empresa->insertar( html_entity_decode($razonsocial, ENT_QUOTES | ENT_HTML401, 'UTF-8'),  html_entity_decode($ncomercial, ENT_QUOTES | ENT_HTML401, 'UTF-8'),
        $domicilio, $ruc, $tel1, $tel2, $correo, $web, $webconsul, $imagen, $ubigueo, $igv, $porDesc, $codubigueo, $ciudad, $distrito, $interior, 
        $codigopais, $banco1, $cuenta1, $banco2, $cuenta2, $banco3, $cuenta3, $banco4, $cuenta4, $cuentacci1, $cuentacci2, $cuentacci3,
      ...
      $rspta = $empresa->editar( $idempresa, html_entity_decode($razonsocial, ENT_QUOTES | ENT_HTML401, 'UTF-8'), html_entity_decode($ncomercial, ENT_QUOTES | ENT_HTML401, 'UTF-8'),
        $domicilio, $ruc, $tel1, $tel2, $correo, $web, $webconsul, $imagen,$ubigueo,$igv,$porDesc,$codubigueo,$ciudad, $distrito,
        $interior, $codigopais, $banco1, $cuenta1, $banco2, $cuenta2, $banco3, $cuenta3, $banco4, $cuenta4, $cuentacci1,
        $cuentacci2, $cuentacci3, $cuentacci4, $tipoimpresion, $textolibre
      );
  ...
  case 'listar':
    ...
    while ($reg = $rspta->fetch_object()) {
      $data[] = array(
        ...
        "4" => $reg->telefono1,
        "5" => $reg->web,
        "6" => ($reg->logo == "") ? "<img src='../files/logo/simagen.png' height='50px' width='50px'>" : "<img src='../files/logo/" . $reg->logo . "' height='50px' width='50px'>"
      );
    }
