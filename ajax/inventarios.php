        ...
        if ($anoregart==$Year) {
            ...
            $data[]=array(
                ...
                <div class="dropdown-menu" style="">
                    ...
                    <a  class="dropdown-item"  target="_blank" href="../reportes/kardexArticulo.php?codigoI='.$reg22->codigo.'&anoo='.$reg22->ano.'&f1='.$fecha1.'&f2='.$fecha2.'">Ver reporte kardex</a>
                    <a class="dropdown-item" onclick="guardarregistro('.$reg22->idregistro.')">Guardar en inventario</a>
