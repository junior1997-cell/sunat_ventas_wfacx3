...
$venta = new Venta();
$rspta = $venta->regventareporte($ano,$mes, $_SESSION['idempresa']);
$rspta2 = $venta->regventareportetotales($ano,$mes, $_SESSION['idempresa']);
$tproductos = $venta->regventareportetotalesProducto($ano,$mes, $_SESSION['idempresa']);
$tservicios = $venta->regventareportetotalesServicios($ano,$mes, $_SESSION['idempresa']);
$tnotapedido = $venta->regventareportetotalesNotapedido($ano,$mes, $_SESSION['idempresa']);
$tnotacredito = $venta->regventareportetotalesNotacredito($ano,$mes, $_SESSION['idempresa']);
$tnotadebito = $venta->regventareportetotalesNotadebito($ano,$mes, $_SESSION['idempresa']);
...
$pdf->Row(array('',utf8_decode('TOTAL SERVICIOS (S/): '),number_format($stotals,2),'', number_format($igvs,2),'',number_format($icbper2,2),'', number_format($totals,2)));

$pdf->Row(array('',utf8_decode('TOTAL PRODUCTOS (S/): '),number_format($stotalp,2),'', number_format($igvp,2),'', number_format($totalp,2)));

$pdf->Row(array('',utf8_decode('TOTAL NOTAS DE PEDIDO (S/): '),number_format($stotaln,2),'', number_format($igvn,2),'', number_format($totaln,2)));

$pdf->Row(array('',utf8_decode('TOTAL NOTAS  DEBITO (S/): '),number_format($stotalnd,2),'', number_format($igvnd,2),'', number_format($totalnd,2)));

$pdf->Row(array('',utf8_decode('TOTAL NOTAS  CREDITO (S/): '),number_format($stotalnc,2),'', number_format($igvnc,2),'', number_format($totalnc,2)));
...
$pdf->Ln(5);
$pdf->SetFont('arial','B',8);
$pdf->Row(array('',utf8_decode('TOTAL GENERAL (S/): '),number_format($stotal,2),'', number_format($igv,2),'', number_format($total,2)));
