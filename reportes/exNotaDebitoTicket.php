...
//$rspta = $notacd->cabecerancreditoFac($_GET["id"]);

$tipodoc=$_GET['tipodoc'];
if ($tipodoc=="01") {
    $rspta = $notacd->cabecerandebitoFac($_GET["id"], $_SESSION['idempresa']);
}else{
    $rspta = $notacd->cabecerandebitoBol($_GET["id"], $_SESSION['idempresa']);
}
...
<table border="0" align="center" width="230px">
    <tr>
        ...
        <tr>
        <td align="center">
    <strong> NOTA DE DEBITO ELECTRÓNICA </br>
...
<table border="0"  width="220px" style="font-size: 11px"  align="center">
    <tr>
        <td>Cant.</td>
...
//set it to writable location, a place for temp generated PNG files
    ...
    $dataTxt=$reg->numero_ruc."|".$reg->codigo_nota."|".$reg->serie."|".$reg->numeronota."|".$reg->igv."|".$reg->total."|".$reg->femisionfac."|".$reg->femision."|".$reg->numerncd."|";
...
if ($tipodoc=="01") {
    $rsptad = $notacd->detalleNotacredito($_GET["id"], $_SESSION['idempresa']  ,$reg->nfactura);
    ...
    ?>
        ...
        <tr><td colspan='5'><strong>Total descuento: </strong></td><td>0.00</td></tr>
        ...
        <tr><td colspan='5'><strong>I.G.V. 18.00: </strong></td><td><?php  echo $reg->igv ?></td></tr>
        </table>
...
<table border='0'  width='220px' style='font-size: 12px'  align="center">
    <tr><td align='right'><strong>TOTAL:  <?php echo $reg->total ?></strong></td></tr><br>
    <tr>
