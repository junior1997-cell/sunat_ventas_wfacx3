...
//set it to writable location, a place for temp generated PNG files
    ...
    $dataTxt=$reg->numero_ruc."|".$reg->codigo_nota."|".$reg->serie."|".$reg->numeronota."|".$reg->igv."|".$reg->total."|".$reg->femisionbol."|".$reg->femision."|".$reg->numerncd."|";
