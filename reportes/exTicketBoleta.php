   ...
   <!--  <tr>
    ...
    <tr>
        <td ><strong>Observación:</strong> 
         <?php echo $reg->descripcion_leyenda_26_2; ?></td>
    </tr>
    </tbody>
</table>
<br>
...
//===============SEGUNDA COPIA DE BOLETA=========================
    ...
    ?>
        ...
        <tr><td colspan='5'><strong>Descuento </strong></td><td>:</td><td><?php  echo $reg->tdescuento ?></td></tr>
        ...
        <tr><td colspan='5'><strong>I.G.V.</strong></td><td >:</td><td><?php echo $reg->igv ?></td></tr>
        <tr><td colspan='5'><strong>Imp. Pagado: </strong></td><td >:</td><td><?php  echo $reg->ipagado ?></td></tr>
        <tr><td colspan='5'><strong>Vuelto: </strong></td><td >:</td><td><?php  echo $reg->saldo ?></td></tr>
...
<table border='0'  width='220px' style='font-size: 12px'  align="center">
    <tr><td><strong>Importe a pagar </strong></td><td>:</td><td><strong><?php echo $reg->Itotal ?></strong></td></tr><br>
...
<div style="text-align: center;" >
    ...
    <br>
    <br>
    <label>Representación impresa de la Boleta de<br>Venta Electrónica puede ser consultada<br>en https://www.servitecfl.com/</label>
    <br>
    <br>
