...
//Enviamos los datos del cliente al método addClientAdresse de la clase Factura
$pdf->addClientAdresse( $regv->fecha."   /  Hora: ".$regv->hora,    utf8_decode(htmlspecialchars_decode($regv->cliente)), $regv->numero_documento, utf8_decode(htmlspecialchars_decode($regv->direccion)), $regv->estado, utf8_decode($regv->vendedorsitio), utf8_decode($regv->descripcion_leyenda_31_2), utf8_decode($regv->tipopago), $letraCuota, $regv->moneda,
