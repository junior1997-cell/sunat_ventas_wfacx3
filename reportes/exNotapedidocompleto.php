...
if (!isset($_SESSION["nombre"])) {
    ...
    if ($_SESSION['ventas'] == 1) {
        ...
        $rutasalidanotapedido = $Prutas->salidanotapedidos;
        $rutalogo = $Prutas->rutalogo;




        $rsptav = $notapedido->ventacabecera($_GET["id"], $_SESSION['idempresa']);
        ...
        $pdf->observSunat($regv->numeracion_07, $datose->observacion);
        ...
        $pdf->addTVAs($regv->subtotal, $regv->adelanto, $regv->faltante, $regv->itotal);
        $pdf->addCadreEurosFrancs($regv->subtotal, $regv->adelanto, $regv->faltante, );
...
// //set it to writable location, a place for temp generated PNG files
        ...
        //$Factura=$pdf->Output('../notapedidosPDF/'.$regv->numeracion_07.'.pdf','F');
        $pdf->Output($rutasalidanotapedido . $regv->numeracion_07 . '.pdf', 'F');
