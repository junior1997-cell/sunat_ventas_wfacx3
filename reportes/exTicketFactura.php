...
<table style="font-size: 8px;" border="0" align="center" width="230px">
    <tbody>
    <tr>
        <td align="left"><strong>Cliente: </strong><?php echo $reg->cliente; ?></td>
    </tr>

    <tr>
        <td align="left"><strong>Documento: </strong>RUC - <?php echo $reg->numero_documento; ?></td>
    </tr>

    <tr>
        <td align="left"><strong>Dirección: </strong><?php  echo utf8_decode(strtoupper($reg->direccion)); ?></td>
    </tr>

    <tr>
        <td align="left"><strong>Fec. de emision: </strong><?php echo $reg->fecha; ?></td>
    </tr>

    <tr>
        <td align="left"><strong>Fec. de vencimiento: </strong><?php echo $reg->fechavenc; ?></td>
    </tr>


    <tr>
        <td align="left"><strong>Moneda: </strong><?php echo $reg->moneda; ?> </td>
    </tr>

    <tr>
        <td align="left"><strong>Vendedor: </strong><?php echo $reg->vendedorsitio; ?></td>
    </tr>

    <tr>
        <td align="left"><strong>Tipo de pago: </strong><?php echo $reg->tipopago; ?> </td>
    </tr>

    <tr>
        <td align="left"><strong>Obs: </strong><?php echo $reg->descripcion_leyenda_31_2; ?> </td>
    </tr>


    <td>
      <?php
        if ($reg->tipopago == "Credito") {
            echo "<table>";
              echo  "<tr>";
...
//======= PARA EXTRAER EL HASH DEL DOCUMENTO FIRMADO ========================================
    ...
    <tr>
      <td colspan="5">-----------------------------------------------------</td>
        ...
        <tr><td colspan='5'><strong>Descuento</strong></td><td>: <?php  echo $reg->tdescuento ?></td></tr>
       ...
       <tr><td colspan='5' ><strong>Op. Exonerado</strong></td><td>: <?php  echo $nombretexo; ?></td></tr>
        ...
        <tr><td colspan='5'><strong>I.G.V.</strong></td><td>: <?php  echo $reg->sumatoria_igv_22_1 ?></td></tr>
        ...
        <tr><td colspan='5'><strong>Vuelto</strong></td><td>: <?php  echo $reg->saldo ?></td></tr>

        <tr><td colspan='5'><strong>Importe a pagar</strong></td><td>: <?php echo $reg->importe_total_venta_27 ?></td></tr>
...
<table border='0'  width='230px' style='font-size: 8px'  align="center">
    ...
    <tr>
      <td align="center"><?php echo $reg->hashc; ; ?></td>
    </tr>
    <tr>
      <td align="center">Representación impresa de la Factura de Venta Electrónica puede ser consultada en https://www.servitecfl.com/</td>
    </tr>
